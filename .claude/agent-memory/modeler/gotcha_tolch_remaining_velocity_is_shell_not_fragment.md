...
description: Tolch 1938's "remaining velocity" axis is the shell's velocity at burst, not fragment decay — its card.md wrongly sells it as a drag anchor
metadata:
  type: project
---

In `doc-reference/wound-ballistics/tolch-1938-m48-panel-pit-fragmentation/`,
