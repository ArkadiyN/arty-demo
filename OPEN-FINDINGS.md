...
- **headline 1.221x/2.05x C5 figures rest on the inadmissible 0.36g/838m/s datum (iv) though the sound census-grading argument (i) alone suffices; three status surfaces lead with the numeric figures instead of (i)**
    ...
    - raised: 2026-08-10 (5d) in `experiment/fragmentation-field/challenges/count-gap-1938/count-chain.md:70`
...
- **the four-digit perforating-fragment velocity still renders as "27^0 f/s" at tolch-1938.md:146,1658,1698 with the third digit lost - resolving it needs a re-fetch of source.pdf (sha256 13e110d70b1cb686771d6f2e36523d9c9201551d41c7b3b9eb27685d71f90c92 per card.md:75, currently missing from the doc-reference directory) from DTIC AD0702233, then a vision read of those three pages**
    ...
    - raised: 2026-08-03 (12d) in `experiment/fragmentation-field/challenges/source-data-audit/review-void-rulings.md:290`
...
- **C1 plug-shear threshold rescales to 0.065 g at 838 m/s vs. Tolch's smallest observed perforation 0.36 g (5.6x permissive in mass); rests on an unanchored datum**
    ...
    - raised: 2026-08-10 (5d) in `experiment/fragmentation-field/challenges/count-gap-1938/count-chain.md:504`
...
- **this section's headline direction ("power-law tail means more sub-gram fragments than Mott, so Mott under-counts") is sign-wrong for the 75mm M48/Tolch application — checked numerically against Tolch's own pit census (`experiment/fragmentation-field/challenges/count-gap-1938/mott-tail-shape.md` §4), splicing the collected sources' τ=1.9–2.2 power law drives the residual *up* (0.31–0.72× credit), and the source studies are brittle-sphere impact / glass rods / mercury droplets, not an HE-driven thick-walled steel cylinder; Elek & Jaramaz's own survey states the power law "cannot successfully describe the HE projectile fragmentation"**
    ...
    - raised: 2026-08-15 (0d) in `doc-reference/mott-distribution-small-fragments/index.md:45`
