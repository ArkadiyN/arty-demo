...
**33 open** — 0 blocking, 0 older than 30 days.
...
- **c=1.25 is derived from a single 155mm HE M101 test article (Grady Fig. 10 only), narrower than the 3-dataset/casing-type base it corrects, and is applied as one global multiplier across all four SHELLS calibers with no evidence the mass-aspect-ratio trend generalizes beyond 155mm**
    ...
    - raised: 2026-08-16 (0d) in `experiment/fragmentation-field/updates/mass-dependent-fragment-shape/derivation.md:285`
- **the B(r) cross-check (155mm, same caliber family as the c=1.25 source data) and the count-chain cross-check (75mm M48) are not caliber-matched to each other, so the count-chain's /700 shortfall may be a caliber-transfer artifact rather than a confirmed uncorrected shape-moment residual**
    - affects: `experiment/fragmentation-field/updates/mass-dependent-fragment-shape/derivation.md`, `experiment/fragmentation-field/challenges/count-gap-1938/count-chain.md`
    - raised: 2026-08-16 (0d) in `experiment/fragmentation-field/updates/mass-dependent-fragment-shape/derivation.md:304`
- **c=1.25 is built from the same Group-discretized Table 3 data as k and is structurally a lower bound (within-Group mass-aspect covariance is invisible to the between-Group calculation), directionally identical to k's disclosed lower-bound caveat but not previously stated for c**
    - affects: `experiment/fragmentation-field/updates/mass-dependent-fragment-shape/derivation.md`
    - raised: 2026-08-16 (0d) in `experiment/fragmentation-field/updates/mass-dependent-fragment-shape/derivation.md:305`
