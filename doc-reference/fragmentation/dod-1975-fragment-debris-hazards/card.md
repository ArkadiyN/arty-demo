...
(image: `images/figure-3-drag-coefficient-vs-mach.png`). Read directly off the
digitized curve:

- **Subsonic (M < 0.7):** flat at $C_D \approx 1.08$.
- **Transonic (M ≈ 0.7–1.0):** steep rise from 1.08 to ~1.27.
- **Peak (M ≈ 1.5):** $C_D \approx 1.40$ — the local peak near sound speed
    mentioned in the text is a real ~9% bump above the supersonic plateau, not
    a minor wiggle.
- **Supersonic plateau (M ≳ 3):** settles to $C_D \approx 1.28$, flat out to
