...
Cylinder dominates interior volume → $C^c \approx 1.72,\text{kg}$, ogive $C^o \approx 0.38,\text{kg}$, boattail $C^t \approx 0.06,\text{kg}$, base (equivalent column) $C^b_\text{eff} \approx 0.02,\text{kg}$.
